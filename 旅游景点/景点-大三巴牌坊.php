...
?>   
    <div class="div1">
        <div class="guide"><p>大三巴牌坊</p></div>
        <img src="photo/景点-大三巴牌坊/大三巴1.jpg">       <!--div1图片600*1520-->
    </div>
    <div style="padding:100px 200px 0px 200px;display:flex;justify-content: space-between;">
        <div class="title">东西结合的<br>天主教堂石壁</div>
        <div class="snum">
    ...
    <div class="text" style="font-size:20px;">
        大三巴牌坊是天主之母教堂（即圣保禄教堂）正面前壁的遗址。<br>
        圣保禄教堂附属于圣保禄学院。该学院于1594年成立，1762年结束，是远东地区第一所西式大学。
        1835年一场大火烧毁了圣保禄学院及其附属的教堂，仅剩下教堂的正面前壁、大部分地基以及教堂前的石阶。自此，这便成为世界闻名的圣保禄教堂遗址。本地人因教堂前壁形似中国传统牌坊，将之称为大三巴牌坊。这座中西合璧的石壁在全世界的天主教教堂中是独一无二的。
    </div>
    <div class="info">
    ...
    <div class="div3">
        ...
        <div>
            <img id="img1" src="photo/景点-大三巴牌坊/图片1_副本.jpg">      <!--div3下图片初始2张700*525；记得在底下imgarray补充全部图片-->
            <img id="img2" src="photo/景点-大三巴牌坊/图片2.jpg">
            <div class="arrow">
    ...
    <script>
        ...
        var imgarray=["photo/景点-大三巴牌坊/图片1_副本.jpg","photo/景点-大三巴牌坊/图片2.jpg","photo/景点-大三巴牌坊/图片3.jpg","photo/景点-大三巴牌坊/图片4.jpg","photo/景点-大三巴牌坊/图片5.jpg"]
    ...
    <script>  
        ...
        function changepic() {  //上传图片
            ...
            var imglocation=showimage("旅游景点/photo/景点-大三巴牌坊/"+f['name']);
