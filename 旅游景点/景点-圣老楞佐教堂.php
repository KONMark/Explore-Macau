...
?>   
<div class="div1">
  <div class="guide"><p>圣老楞佐教堂</p></div>
    <img src="photo/景点-圣老楞佐教堂/教堂封面.jpg">       <!--div1图片600*1520-->
  </div>
    <div style="padding:100px 200px 0px 200px;display:flex;justify-content: space-between;">
        <div class="title">最具古雅逸趣的<br>澳门老教堂</div>
        <div class="snum">
    ...
    <div class="text" style="font-size:20px;">
        圣老楞佐教堂为一层建筑，入口部分有夹层，钟楼为三层。<br>从天花板之上垂下数个华丽的枝型大吊灯，室内装饰充满东方色彩，古雅逸趣。<br>
教堂祭坛内供奉着圣老楞佐的神像，穿着绚丽的衣袍，一手持圣经，一手拿法杖，庄严肃穆。<br>在经常航海的葡国人心目中，圣老楞佐是庇佑平安、赐予风信之神。<br>
蓝色的顶棚、黄色的墙面、彩色玻璃窗既有描绘圣经题材的复杂图案，又有简洁明快的现代造型，色彩对比鲜明，给教堂增加了亮点。
    ...
    <div class="info">
        ...
        <div>&nbsp;开放时间</div>
        <p>星期一至五：上午6时30分至傍晚6时30<br>
星期六及日：上午6时30分至晚上9时</p>
    </div>
    <div class="div3">
        ...
        <div>
            <img id="img1" src="photo/景点-圣老楞佐教堂/推荐1.png">      <!--div3下图片初始2张700*525；记得在底下imgarray补充全部图片-->
            <img id="img2" src="photo/景点-圣老楞佐教堂/推荐2.jpg">
            <div class="arrow">
    ...
    <script>
        ...
        var imgarray=["photo/景点-圣老楞佐教堂/推荐1.png","photo/景点-圣老楞佐教堂/推荐2.jpg","photo/景点-圣老楞佐教堂/推荐3.jpg","photo/景点-圣老楞佐教堂/推荐4.jpg","photo/景点-圣老楞佐教堂/推荐5.jpg"]
    ...
    <script>
     ...
     <script>  
        ...
        function changepic() {  //上传图片
            ...
            var imglocation=showimage("旅游景点/photo/景点-圣老楞佐教堂/"+f['name']);
