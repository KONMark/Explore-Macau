...
<div class="div1">
  <div class="guide"><p>大潭山瞭望台</p></div>
    ...
    <div class="text" style="font-size:20px;">
        大潭山登山电梯是澳门最高的登山电梯。
在乘坐电梯的过程中，可以从低往高慢慢地升起的气势欣赏整个氹仔新城。
登上瞭望台，可将银河、威尼斯人、新濠天地、望德圣母湾、龙环葡韵等核心的景点尽收眼底。
如若是日落时分，则可以欣赏余晖将新濠天地映射出金光闪闪的美景，吹着凉爽的晚风，十分舒适。
    </div>
    <div class="info">
    ...
    <div class="div3">
        ...
        <div>
            <img id="img1" src="photo/景点-大潭山瞭望台/推荐1.jpg">      <!--div3下图片初始2张700*525；记得在底下imgarray补充全部图片-->
            <img id="img2" src="photo/景点-大潭山瞭望台/推荐2.jpg">
            <div class="arrow">
    ...
    <script>
        ...
        var imgarray=["photo/景点-大潭山瞭望台/推荐1.jpg","photo/景点-大潭山瞭望台/推荐2.jpg","photo/景点-大潭山瞭望台/推荐3.jpg","photo/景点-大潭山瞭望台/推荐4.jpg","photo/景点-大潭山瞭望台/推荐5.jpg"]
    ...
    <script>
        ...
        function changepic() {  //上传图片
            ...
            var imglocation=showimage("旅游景点/photo/景点-大潭山瞭望台/"+f['name']);
