...
?>   
<div class="div1">
  <div class="guide"><p>龙环葡韵</p></div>
    <img src="photo/景点-龙环葡韵/封面.jpg">       <!--div1图片600*1520-->
  </div>
    <div style="padding:100px 200px 0px 200px;display:flex;justify-content: space-between;">
        <div class="title">澳门最温柔的<br>薄荷绿建筑群</div>
        <div class="snum">
    ...
    <div class="text" style="font-size:20px;">
        “龙环葡韵”是澳门八景之一。“龙环”是氹仔旧称，“葡韵”是指这里葡萄牙建筑风韵，包括海边马路的多座葡式住宅、嘉模教堂、公园等一带如诗似画的迷人景致，其中以五座碧翠凝绿的小型建筑最具代表性。<br>
特区政府重新整合利用龙环葡韵的五座建筑，由西向东分别为“葡韵生活馆”、“汇艺廊”、“创荟馆”、“风貌馆”、“迎宾馆”，当中结合特色展览、露天表演及节庆活动等元素，使之成为展示葡语国家文化，以至世界各国文化特色的舞台。
<br>午后漫步在这温柔的绿色中，十分惬意。
    </div>
    <div class="info">
    ...
    <div class="div3">
        ...
        <div>
            <img id="img1" src="photo/景点-龙环葡韵/推荐1.jpg">      <!--div3下图片初始2张700*525；记得在底下imgarray补充全部图片-->
            <img id="img2" src="photo/景点-龙环葡韵/推荐2.jpg">
            <div class="arrow">
    ...
    <script>
        ...
        var imgarray=["photo/景点-龙环葡韵/推荐1.jpg","photo/景点-龙环葡韵/推荐2.jpg","photo/景点-龙环葡韵/推荐3.jpg","photo/景点-龙环葡韵/推荐4.jpg","photo/景点-龙环葡韵/推荐5.jpg"]
    ...
    <script>
        ...
        function changepic() {  //上传图片
            ...
            var imglocation=showimage("旅游景点/photo/景点-龙环葡韵/"+f['name']);
