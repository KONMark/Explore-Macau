...
<body>
    ...
    ?>   
<div class="div1">
  <div class="guide"><p>东望洋炮台</p></div>
    <img src="photo/景点-东望洋炮台/封面.jpg">       <!--div1图片600*1520-->
  </div>
    <div style="padding:100px 200px 0px 200px;display:flex;justify-content: space-between;">
        <div class="title">中国现存最古老的<br>西式炮台建筑群</div>
        <div class="snum">
    ...
    <div class="text" style="font-size:20px;">
        因位于澳门半岛最高的东望洋山而得名，又名基亚（Guia）炮台，华人称松山炮台，有哨房、火药库、楼塔等。
炮台的主要用作防御外敌和观测站。<br>在过去，东望洋炮台与大炮台和妈阁炮台组成一道坚固的外围军事防线。
1976年葡军撤出澳门，炮台始开放成为旅游景点。
东望洋炮台范围包括两个著名的旅游景点：东望洋灯塔和圣母雪地殿教堂。在此可俯瞰澳门全景和珠江口的壮丽景色。
    </div>
    <div class="info">
    ...
    <div class="info">
        ...
        <div>&nbsp;开放时间</div>
        <p>炮台开放时间  9：00-17：30 
东望洋灯塔平日不对外开放，每年一度的港务局日5月20日，灯塔才会向公众开放。</p>
    </div>
    <div class="div3">
        ...
        <div>
            <img id="img1" src="photo/景点-东望洋炮台/推荐1.jpg">      <!--div3下图片初始2张700*525；记得在底下imgarray补充全部图片-->
            <img id="img2" src="photo/景点-东望洋炮台/推荐2.jpg">
            <div class="arrow">
    ...
    <script>
        ...
        var imgarray=["photo/景点-东望洋炮台/推荐1.jpg","photo/景点-东望洋炮台/推荐2.jpg","photo/景点-东望洋炮台/推荐3.jpg","photo/景点-东望洋炮台/推荐4.jpg","photo/景点-东望洋炮台/推荐5.jpg"]
    ...
    <script>  
        ...
        function changepic() {  //上传图片
            ...
            var imglocation=showimage("旅游景点/photo/景点-东望洋炮台/"+f['name']);
